...
--
-- Dumping data for table `madarsa_form`
--

LOCK TABLES `madarsa_form` WRITE;
/*!40000 ALTER TABLE `madarsa_form` DISABLE KEYS */;
INSERT INTO `madarsa_form` VALUES (1,NULL,NULL,NULL);
/*!40000 ALTER TABLE `madarsa_form` ENABLE KEYS */;
UNLOCK TABLES;
