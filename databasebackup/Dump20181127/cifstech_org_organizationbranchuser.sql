...
--
-- Dumping data for table `organizationbranchuser`
--

LOCK TABLES `organizationbranchuser` WRITE;
/*!40000 ALTER TABLE `organizationbranchuser` DISABLE KEYS */;
/*!40000 ALTER TABLE `organizationbranchuser` ENABLE KEYS */;
UNLOCK TABLES;
